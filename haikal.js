...
"sourceUrl": `https://chat.whatsapp.com/FM1nyVN3Y1RF05AGtVYQ0O`,
"thumbnailUrl": 'https://i.ibb.co/PM1f3fH/pict.jpg', 
"thumbnail": kalimage
}}}
//=================================================//
const doc = { 
...
"fileName": `CIEL BOT${ngazap(prefix)}`,
...
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/channel/UC4A3W9-KDxPKI2M4muTjGCQ`,
thumbnailUrl: 'https://i.ibb.co/PM1f3fH/pict.jpg', 
thumbnail: kalimage,
}
}}, { quoted:hw})
...
gifPlayback:true,
jpegThumbnail:log0,
caption:`Haii 👋 Kak ${pushname} Selamat ${salam} *Aku Adalah Bot CIEL*
...
anjay(`\`\`\`「 Detect Link 」\`\`\`\n\nUntung yg lu sebar link gc ini`)
...
"fileName": `© BOT CIEL${ngazap(prefix)}`,
...
"caption": `© CIEL BOT${ngazap(prefix)}`,
...
"inviteExpiration": `MY NAME RAJA${ngazap(prefix)}`,
"groupName": `MY NAME BOT CIEL${ngazap(prefix)}`,
...
haikal.sendMessage(m.chat, { document: anuin, mimetype: 'application/octet-stream', fileName: `CIEL ${ngazap(prefix)}.BIN`, title: `CIEL BOT ${ngazap(prefix)}.BIN` }, { quoted: doc })
}
break
//=================================================//
case 'bugtod': {
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
haikal.sendMessage(m.chat, { image: { url: 'https://i.ibb.co/PM1f3fH/pict.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\n Bot Rental Prices\n⭔ 13k Per Group via E-Walet 1 Month\n⭔ 18k via pulsa 1 Month\n\n Premium Price Bot\n⭔ 8k per User 1 bulan\n\nPayment can be via Paypal/link aja/pulsa\n\nFor more details, you can chat with the owner\nhttps://wa.me/6281364440831 (Owner)\n\nDonate For Me : \n\n⭔ Paypal : https://trakteer.id/GaPunya\n⭔ Saweria : https://saweria.co/BotCIEL` }, { quoted: hw })
}
break
//=================================================//
case 'sc': {
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
anjay('Telegram : https://t.me\n\n Sc Bot : https://6281364440831?text=halo+bang+ciel,+saya+ingin+sc+mu')
}
break
//=================================================//
case 'chat': {
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
if (!text) throw 'LINK NYA MAS'
if (!isUrl(args[0]) && !args[0].includes('whatsapp.com')) throw 'Link ga valid anjir'
...
"firstImageId": 1,
"salePriceAmount1000": "10000000",
"retailerId": `© CIEL BOT WE ARE NOT MASTOD`,
"url": "Wa.me/6281364440831"
},
"businessOwnerJid": "6281364440831@s.whatsapp.net",
}
